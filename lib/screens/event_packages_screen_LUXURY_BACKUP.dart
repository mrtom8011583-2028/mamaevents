                ...
                child: Column(
                  children: [
                    ...
                    Wrap(
                      ...
                      children: [
                        _buildTrustItem(Icons.star, 'Premium Quality', 'Only the finest ingredients.'),
                        _buildTrustItem(Icons.person, 'Expert Chefs', 'Masters of culinary art.'),
                        _buildTrustItem(Icons.verified_user, 'Reliable Service', 'On time, every time.'),
                      ],
                    ),
                     const SizedBox(height: 32),
                     const GoldDivider(),
